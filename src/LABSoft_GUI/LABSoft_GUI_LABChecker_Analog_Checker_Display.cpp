    ...
    : Fl_Group(X, Y, W, H, label)
{
    ...
    oscilloscope_display = new LABSoft_GUI_Oscilloscope_Display(270, 90, 930, 485, " ");
...
cb_trigger_level_static (Fl_Widget* w,
                         void*      data)
{
  LABSoft_GUI_LABChecker_Analog_Checker_Display* disp = 
    static_cast<LABSoft_GUI_LABChecker_Analog_Checker_Display*>(w->parent ());
}
...
double LABSoft_GUI_LABChecker_Analog_Checker_Display:: 
