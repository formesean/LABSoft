...
private:
  std::array<double, LABC::OSC_DISPLAY::NUMBER_OF_CHANNELS>
      m_voltage_per_division = { 0.0 };
  std::array<double, LABC::OSC_DISPLAY::NUMBER_OF_CHANNELS> m_vertical_offset
      = { 0.0 };
  ...
  std::array<Fl_Button *, LABC::OSC_DISPLAY::NUMBER_OF_CHANNELS>
      m_channel_selectors;

  std::array<Fl_Box *, LABC::OSC_DISPLAY::NUMBER_OF_COLUMNS + 1>
      m_time_per_division_labels;

  std::array<std::array<Fl_Box *, LABC::OSC_DISPLAY::NUMBER_OF_ROWS + 1>,
             LABC::OSC_DISPLAY::NUMBER_OF_CHANNELS>
      m_voltage_per_division_labels;

  std::array<Fl_Box *, LABC::OSC_DISPLAY::NUMBER_OF_CHANNELS>
...
public:
  LABSoft_GUI_Oscilloscope_Display (int X, int Y, int W, int H,
                                    const char *label = 0);
