...
LABSoft_GUI_Oscilloscope_Display::LABSoft_GUI_Oscilloscope_Display(
  int X,
  int Y,
  int W,
  int H,
...
void
LABSoft_GUI_Oscilloscope_Display::load_presenter(
  const LABSoft_Presenter& presenter)
{
...
void
LABSoft_GUI_Oscilloscope_Display::load_pixel_points(
  const LABSoft_GUI_Oscilloscope_Display::PixelPoints& pixel_points)
{
  m_internal_display->load_pixel_points(pixel_points);
}

void
LABSoft_GUI_Oscilloscope_Display::init_child_widgets()
{
...
void
LABSoft_GUI_Oscilloscope_Display::draw()
{
...
void
LABSoft_GUI_Oscilloscope_Display::update_display()
{
  m_internal_display->update_display();
}

void
LABSoft_GUI_Oscilloscope_Display::trigger_source(unsigned channel)
{
}

void
LABSoft_GUI_Oscilloscope_Display::trigger_channel(unsigned channel)
{
...
void
LABSoft_GUI_Oscilloscope_Display::trigger_level(double value)
{
}

void
LABSoft_GUI_Oscilloscope_Display::status(LABE::OSC::STATUS status)
{
...
void
LABSoft_GUI_Oscilloscope_Display::init_child_widgets_internal_display()
{
...
void
LABSoft_GUI_Oscilloscope_Display::init_child_widgets_sliders()
{
  const LABSoft_GUI_Oscilloscope_Internal_Display& disp = *m_internal_display;

  // 2.1
  m_vertical_offset_slider = new LABSoft_GUI_Fl_Slider(
    disp.x(), disp.y(), LABC::OSC_DISPLAY::SLIDER_WIDTH, disp.h());
  ...
  m_vertical_offset_slider->step(disp.h(),
                                 LABC::OSC_DISPLAY::NUMBER_OF_ROWS *
                                   LABC::OSC_DISPLAY::NUMBER_OF_MINOR_TICKS);

  // 2.2 trigger level
  m_trigger_level_slider = new LABSoft_GUI_Fl_Slider(
    disp.x() + disp.w() - LABC::OSC_DISPLAY::SLIDER_WIDTH,
    disp.y(),
    LABC::OSC_DISPLAY::SLIDER_WIDTH,
    disp.h());
  ...
  m_trigger_level_slider->step(disp.h(),
                               LABC::OSC_DISPLAY::NUMBER_OF_ROWS *
                                 LABC::OSC_DISPLAY::NUMBER_OF_MINOR_TICKS);
  m_trigger_level_slider->callback(cb_trigger_level_static);

  // 2.3 horizontal offset
  m_horizontal_offset_slider = new LABSoft_GUI_Fl_Slider(
    disp.x(), disp.y(), disp.w(), LABC::OSC_DISPLAY::SLIDER_WIDTH);
  ...
  m_horizontal_offset_slider->step(disp.w(),
...
void
LABSoft_GUI_Oscilloscope_Display::init_child_widgets_status()
{
  m_status =
    new Fl_Box(m_internal_display->x(),
  ...
  init_child_widgets_voltage_per_division_labels()
{
  for (unsigned chan = 0; chan < m_voltage_per_division_labels.size(); chan++) {
    int X = m_internal_display->x() -
            (LABC::OSC_DISPLAY::Y_AXIS_LABEL_HORIZONTAL_INTRASPACE *
             static_cast<int>(m_voltage_per_division_labels.size())) +
            (LABC::OSC_DISPLAY::Y_AXIS_LABEL_HORIZONTAL_INTRASPACE * chan);

    for (unsigned row = 0; row < m_voltage_per_division_labels[chan].size();
         row++) {
      int Y = static_cast<int>(std::round(
        m_internal_display->y() + (row * m_internal_display->row_height())));
    ...
    m_voltage_per_division_labels[chan].front()->align(FL_ALIGN_TOP_LEFT |
                                                       FL_ALIGN_INSIDE);
...
void
LABSoft_GUI_Oscilloscope_Display::init_child_widgets_voltage_per_division_units(
  int X,
  unsigned chan)
{
  char label[20];
...
void
LABSoft_GUI_Oscilloscope_Display::init_child_widgets_time_per_division_labels()
{
  for (unsigned a = 0; a < m_time_per_division_labels.size(); a++) {
    Fl_Box* box =
      new Fl_Box(static_cast<int>(m_internal_display->x() +
                                  (a * m_internal_display->column_width())),
...
void
LABSoft_GUI_Oscilloscope_Display::init_child_widgets_channel_selectors()
{
  for (unsigned a = 0; a < m_channel_selectors.size(); a++) {
    Fl_Button* butt = new Fl_Button(m_status->x() + m_status->w() +
                                      (a * LABC::OSC_DISPLAY::STATUS_HEIGHT),
                                    m_status->y(),
                                    LABC::OSC_DISPLAY::STATUS_HEIGHT,
                                    LABC::OSC_DISPLAY::STATUS_HEIGHT);
...
void
LABSoft_GUI_Oscilloscope_Display::init_child_widgets_top_info()
{
  m_top_info = new Fl_Box(m_status->x() + m_status->w() + 10 +
                            (LABC::OSC_DISPLAY::STATUS_HEIGHT *
                             static_cast<int>(m_channel_selectors.size())),
                          m_status->y(),
                          3,
                          m_status->h());
...
void
LABSoft_GUI_Oscilloscope_Display::cb_trigger_level_static(Fl_Widget* w,
                                                          void* data)
{
...
void
LABSoft_GUI_Oscilloscope_Display::cb_channel_selector_static(Fl_Widget* w,
                                                             void* data)
{
  LABSoft_GUI_Oscilloscope_Display& disp =
    *(static_cast<LABSoft_GUI_Oscilloscope_Display*>(w->parent()));
...
void
LABSoft_GUI_Oscilloscope_Display::update_gui_voltage_per_division_labels()
{
  for (unsigned chan = 0; chan < m_voltage_per_division_labels.size(); chan++) {
...
void
LABSoft_GUI_Oscilloscope_Display::update_gui_time_per_division_labels()
{
...
void
LABSoft_GUI_Oscilloscope_Display::update_gui_top_info()
{
  LABSoft_GUI_Label label(m_sampling_rate, LABSoft_GUI_Label::UNIT::HERTZ);

  std::stringstream ss;

  ss << m_samples << " samples at " << label.to_text() << " | "
...
void
LABSoft_GUI_Oscilloscope_Display::update_gui_vertical_elements()
{
...
void
LABSoft_GUI_Oscilloscope_Display::update_gui_horizontal_elements()
{
  // update_gui_time_per_division ();
}

void
LABSoft_GUI_Oscilloscope_Display::update_gui_trigger_level_slider()
{
  ...
  // double max_bounds   = max_tpd_raw - m_osc->vertical_offset
  // (trigger_source); double min_bounds   = min_tpd_raw -
  // m_osc->vertical_offset (trigger_source);
...
void
LABSoft_GUI_Oscilloscope_Display::update_gui_vertical_offset_slider()
{
...
double
LABSoft_GUI_Oscilloscope_Display::calc_row_voltage_per_division(
  unsigned channel,
  unsigned row)
{
  ...
  double row_vpd =
    (-index * m_voltage_per_division[channel]) - m_vertical_offset[channel];

  return (row_vpd);
}

double
LABSoft_GUI_Oscilloscope_Display::calc_col_time_per_division(unsigned col)
{
...
void
LABSoft_GUI_Oscilloscope_Display::mark_samples(bool state)
{
  m_internal_display->mark_samples(state);
}

void
LABSoft_GUI_Oscilloscope_Display::channel_enable_disable(unsigned channel,
                                                         bool state)
{
...
void
LABSoft_GUI_Oscilloscope_Display::vertical_offset(unsigned channel,
                                                  double value)
{
...
void
LABSoft_GUI_Oscilloscope_Display::voltage_per_division(unsigned channel,
                                                       double value)
{
...
void
LABSoft_GUI_Oscilloscope_Display::horizontal_offset(double value)
{
...
void
LABSoft_GUI_Oscilloscope_Display::time_per_division(double value)
{
...
void
LABSoft_GUI_Oscilloscope_Display::samples(unsigned value)
{
  m_samples = value;
}

void
LABSoft_GUI_Oscilloscope_Display::sampling_rate(double value)
{
  m_sampling_rate = value;
}

unsigned
LABSoft_GUI_Oscilloscope_Display::display_width() const
{
  return (m_internal_display->w());
}

unsigned
LABSoft_GUI_Oscilloscope_Display::display_height() const
{
  return (m_internal_display->h());
}

void
LABSoft_GUI_Oscilloscope_Display::hide_voltage_per_division_labels(
  unsigned channel)
{
...
void
LABSoft_GUI_Oscilloscope_Display::show_voltage_per_division_labels(
  unsigned channel)
{
  m_voltage_per_division_units.at(channel)->hide();
