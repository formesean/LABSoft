...
LABSoft_Presenter_Logic_Analyzer::LABSoft_Presenter_Logic_Analyzer(
...
void
LABSoft_Presenter_Logic_Analyzer::init()
{
  gui().logic_analyzer_labsoft_gui_logic_analyzer_display->load_parent_data(
    lab().m_Logic_Analyzer.parent_data());
}

void
LABSoft_Presenter_Logic_Analyzer::init_gui_values()
{
  LAB_Logic_Analyzer& logan = lab().m_Logic_Analyzer;

  // Horizontal
  gui().logic_analyzer_fl_input_choice_horizontal_offset->value(
    LABSoft_GUI_Label(logan.horizontal_offset())
      .to_text(LABSoft_GUI_Label::UNIT::SECOND)
      .c_str());

  gui().logic_analyzer_fl_input_choice_time_per_division->value(
    LABSoft_GUI_Label(logan.time_per_division())
      .to_text(LABSoft_GUI_Label::UNIT::SECOND_PER_DIVISION)
      .c_str());

  gui().logic_analyzer_fl_input_choice_samples->value(
    LABSoft_GUI_Label(logan.samples())
      .to_text(LABSoft_GUI_Label::UNIT::NONE)
      .c_str());

  gui().logic_analyzer_fl_input_choice_sampling_rate->value(
    LABSoft_GUI_Label(logan.sampling_rate())
      .to_text(LABSoft_GUI_Label::UNIT::HERTZ)
      .c_str());

  // Display
  gui()
    .logic_analyzer_labsoft_gui_logic_analyzer_add_channel_signal_window
...
void
LABSoft_Presenter_Logic_Analyzer::cb_run_stop(Fl_Light_Button* w, void* data)
{
  if (w->value() == 0) {
...
void
LABSoft_Presenter_Logic_Analyzer::cb_single(Fl_Button* w, void* data)
{
...
void
LABSoft_Presenter_Logic_Analyzer::cb_horizontal_offset(Fl_Input_Choice* w,
                                                       void* data)
{
  LABSoft_GUI_Label lbl(w->value(),
...
void
LABSoft_Presenter_Logic_Analyzer::cb_time_per_division(Fl_Input_Choice* w,
                                                       void* data)
{
  LABSoft_GUI_Label lbl(w->value(),
...
void
LABSoft_Presenter_Logic_Analyzer::cb_samples(Fl_Input_Choice* w, void* data)
{
  LABSoft_GUI_Label lbl(w->value(),
  ...
  if (lbl.is_valid()) {
    lab().m_Logic_Analyzer.samples(
      static_cast<unsigned>(std::round(lbl.actual_value())));
  }
...
void
LABSoft_Presenter_Logic_Analyzer::cb_sampling_rate(Fl_Input_Choice* w,
                                                   void* data)
{
  LABSoft_GUI_Label lbl(w->value(),
...
void
LABSoft_Presenter_Logic_Analyzer::cb_trigger_mode(Fl_Choice* w, void* data)
{
...
void
LABSoft_Presenter_Logic_Analyzer::cb_trigger_condition(Fl_Menu_Button* w,
                                                       void* data)
{
...
void
LABSoft_Presenter_Logic_Analyzer::cb_mode(Fl_Choice* w, void* data)
{
...
void
LABSoft_Presenter_Logic_Analyzer::display_update_cycle()
{
...
void
LABSoft_Presenter_Logic_Analyzer::update_gui_horizontal()
{
  LABSoft_GUI_Label horizontal_offset(
    lab().m_Logic_Analyzer.horizontal_offset());
  LABSoft_GUI_Label time_per_division(
    lab().m_Logic_Analyzer.time_per_division());
  ...
  // 2. Time per Division
  gui().logic_analyzer_fl_input_choice_time_per_division->value(
    time_per_division.to_text(LABSoft_GUI_Label::UNIT::SECOND_PER_DIVISION)
      .c_str());
...
void
LABSoft_Presenter_Logic_Analyzer::update_gui_mode()
{
...
void
LABSoft_Presenter_Logic_Analyzer::cb_add_channel_selection(Fl_Menu_* w,
                                                           void* data)
{
  gui()
    .logic_analyzer_labsoft_gui_logic_analyzer_add_channel_signal_window
...
void
LABSoft_Presenter_Logic_Analyzer::cb_add_channel_signal(
  LABSoft_GUI_Logic_Analyzer_Add_Channel_Signal_Window* w,
  void* data)
{
  Fl_Input& i = *(w->m_name);
  ...
  for (int line = b.size(); line > 0; line--) {
    if ((b.selected(line)) == 1) {
      ...
      if (*(i.value()) == '\0') {
        std::snprintf(
          ...
          sizeof(label),
          "DIO %d",
          static_cast<int>(reinterpret_cast<uintptr_t>(b.data(line))));
      } else {
        if (added_count == 0) {
          std::snprintf(label, sizeof(label), "%s", i.value());
        } else {
          std::snprintf(
            label, sizeof(label), "%s%d", i.value(), added_count + 1);
        }
      }
...
void
LABSoft_Presenter_Logic_Analyzer::cb_clear_channels(Fl_Menu_* w, void* data)
{
