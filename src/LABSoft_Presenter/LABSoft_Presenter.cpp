...
LABSoft_Presenter::LABSoft_Presenter(LAB& _LAB, LABSoft_GUI& _LABSoft_GUI)
  : m_LAB(_LAB)
...
void
LABSoft_Presenter::load_presenter_to_gui()
{
...
void
LABSoft_Presenter::update_gui_tab_colors()
{
  // 63 is green
...
void
LABSoft_Presenter::update_display(void* data)
{
...
void
LABSoft_Presenter::cb_tabs(Fl_Group* w, void* data)
{
  update_gui_tab_colors();
}

LAB&
LABSoft_Presenter::lab() const
{
  return (m_LAB);
}

LABSoft_GUI&
LABSoft_Presenter::gui() const
{
