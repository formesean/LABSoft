...
LABSoft_Presenter_Main_Window::LABSoft_Presenter_Main_Window(
...
void
LABSoft_Presenter_Main_Window::cb_exit(Fl_Widget* w, void* data)
{
...
void
LABSoft_Presenter_Main_Window::cb_help_about(Fl_Widget* w, void* data)
{
...
void
LABSoft_Presenter_Main_Window::cb_help_about_win_close(Fl_Button* w, void* data)
{
